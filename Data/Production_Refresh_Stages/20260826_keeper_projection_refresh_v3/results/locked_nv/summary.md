...
- Run: `v2_locked_final_nv_20260826T211405Z_99d55e2f`
- Feature run: `milestone_3_20260826T211023Z_f49faf9a`
...
| Method | Pooled RMSE |
|---|---:|
| `conditional_ppg_qb_style_wrte_route` | 2.8373 |
| `conditional_ppg_log_lasso_tree_blend` | 2.8374 |
| `conditional_ppg_history_gap_no_history_route` | 2.8382 |
| `conditional_ppg_projection_history_router` | 2.8383 |
| `conditional_ppg_primary_blend` | 2.8388 |
| `conditional_ppg_random_forest` | 2.8543 |
| `conditional_ppg_lightgbm` | 2.8548 |
| `expert_recalibrated` | 2.9157 |
| `conditional_ppg_lasso` | 2.9192 |
...
|---|---:|---:|---:|---:|
| `primary_vs_expert` | -0.0764 | 9/9 | -0.0712 | [-0.1000, -0.0536] |
| `log_lasso_vs_primary` | -0.0014 | 5/9 | +0.0024 | [-0.0049, +0.0014] |
| `history_gap_route_vs_primary` | -0.0007 | 5/9 | -0.0002 | [-0.0032, +0.0017] |
| `projection_router_vs_primary` | -0.0006 | 2/9 | -0.0027 | [-0.0059, +0.0031] |
| `qb_style_route_vs_primary` | -0.0015 | 7/9 | -0.0032 | [-0.0028, -0.0001] |

## Participation

| Method | Pooled Brier |
|---|---:|
| `participation_lightgbm` | 0.1255 |
| `participation_logistic` | 0.1398 |
| `participation_prior_position_rate` | 0.2434 |

## Calibration and template handoff

- Strict-prior P25-P75 residual coverage: 0.493
