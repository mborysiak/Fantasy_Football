...
c_stat.player = c_stat.player.apply(dc.name_clean)
#%%
...
birthdays.player = birthdays.player.apply(dc.name_clean)    
...
rookie_adp.player = rookie_adp.player.apply(dc.name_clean)
