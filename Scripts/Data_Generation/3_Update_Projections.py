...
dm.delete_from_db('Season_Stats', 'FFToday_Projections', f"year={year}", create_backup=False)
dm.write_to_db(output, 'Season_Stats', 'FFToday_Projections', 'append')

#%%

# pull fantasydata projections
df = pull_fantasy_data(f'fantasy-football-weekly-projections.csv', year)
dm.delete_from_db('Season_Stats', 'FantasyData', f"year={year}", create_backup=False)
dm.write_to_db(df, 'Season_Stats', 'FantasyData', 'append')
...
dm.delete_from_db('Season_Stats', 'FFA_Projections', f"year={year}", create_backup=False)
dm.write_to_db(df, 'Season_Stats', 'FFA_Projections', 'append')
...
dm.delete_from_db('Season_Stats', 'FFA_RawStats', f"year={year}", create_backup=False)
dm.write_to_db(df, 'Season_Stats', 'FFA_RawStats', 'append')
...
for pos in ['qb', 'rb', 'wr', 'te']:
    ...
    dm.write_to_db(df, 'Season_Stats', 'FantasyPros_Projections', 'append')
...
dm.delete_from_db('Season_Stats', 'PFF_Projections', f"year={year}", create_backup=False)
dm.write_to_db(df, 'Season_Stats', 'PFF_Projections', 'append')
