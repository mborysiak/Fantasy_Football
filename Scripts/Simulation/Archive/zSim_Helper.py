...
class FootballSimulation():
    ...
    def __init__(self, conn_sim, table_vers, set_year, league):
        ...
        self.data = pd.read_sql_query(f'''SELECT * FROM {table_vers}_{set_year}
                                          WHERE player IN ('Josh Allen', 'Jalen Hurts', 'Trevor Lawrence', 
                                                        'Jahmyr Gibbs', 'Rhamondre Stevenson', 'Zamir White', 'James Conner', 'Travis Etienne',
                                                        'Mike Evans', 'Cooper Kupp', 'Ceedee Lamb', 'Drake London', 'Christian Kirk', 'Curtis Samuel', 
                                                        'Trey Mcbride', 'Mark Andrews', 'Evan Engram', 'Jake Ferguson')''', conn_sim)
...
path = f'c:/Users/borys/OneDrive/Documents/Github/Fantasy_Football/'
