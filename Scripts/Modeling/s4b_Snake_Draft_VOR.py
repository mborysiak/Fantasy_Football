...
from config import YEAR, LEAGUE, PRED_VERSION, DRAFT_SETTINGS, get_max_pick, DB_NAME
...
def get_this_year_vor(df, year=None):
    if year is None:
        year = YEAR
...
year = YEAR
replacement_ranks = DRAFT_SETTINGS['replacement_ranks']

num_teams = DRAFT_SETTINGS['num_teams']
num_rounds = DRAFT_SETTINGS['num_rounds']
max_pick = get_max_pick()
